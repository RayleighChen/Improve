...
import com.rayleigh.asm.POBuildUtil;
import com.rayleigh.asm.render.RenderClass;
import com.rayleigh.asm.render.RenderProperty;
import com.rayleigh.asm.render.Templates;
...
public class Main {
	...
	public void chenli() throws InstantiationException, IllegalAccessException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException {
		...
		util.build(
				...
				list);
		// 实例化一个person
		Object person = Class.forName("com.rayleigh.asm.bean.Person")
				.newInstance();// hbmcls.newInstance();
		...
		PersistentClass model = config
				.getClassMapping("com.rayleigh.asm.bean.Person");
